          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center space-x-2">
              <div className="text-primary relative">
                ...
                <img src="https://i.postimg.cc/SxbS61PK/EZ-Headshot.png" alt="Enri Zhulati" className="h-8 w-8 rounded-full object-cover relative z-10 border border-blue-500/30" />
              </div>
